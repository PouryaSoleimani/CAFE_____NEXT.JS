        ...
        <div className="col-lg-6 mb-5 hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer">
            ...
            <div className="row align-items-center">
                ...
                <div className="col-sm-7">
                    ...
                    <p className="m-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum iure nam sequi, quaerat ad hic tempore ea culpa quisquam, ab eaque aut voluptas perspiciatis beatae atque sed quibusdam aliquam est?</p>
                </div>
            </div>
            </div>
        </div>
